                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="dependencies/images/product-image/35_1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="dependencies/images/product-image/36_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidecart_pro_img"><img
                                src="dependencies/images/product-image/37_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
        ...
        <div class="container">
            ...
            <div class="row margin-minus-b-15 margin-minus-t-15">
                <div class="ec_cat_content ec_cat_content_1 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/6.jpg" alt="" />
                        </div>
                ...
                <div class="ec_cat_content ec_cat_content_2 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/7.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Furniture</h3>
                            <ul>
                ...
                <div class="ec_cat_content ec_cat_content_3 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/8.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Clothing</h3>
                            <ul>
                ...
                <div class="ec_cat_content ec_cat_content_4 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/9.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Beauty</h3>
                            <ul>
                ...
                <div class="ec_cat_content ec_cat_content_5 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/10.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Watches</h3>
                            <ul>
                ...
                <div class="ec_cat_content ec_cat_content_6 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/11.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Jewellery</h3>
                            <ul>
                ...
                <div class="ec_cat_content ec_cat_content_7 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/12.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Fashion</h3>
                            <ul>
                ...
                <div class="ec_cat_content ec_cat_content_8 col-sm-12 col-md-6 col-lg-3">
                    <div class="ec_cat_inner">
                        <div class="ec-category-image">
                            <img src="dependencies/images/category-image/13.jpg" alt="" />
                        </div>
                        <div class="ec-category-desc">
                            <h3>Electronic</h3>
                            <ul>
    ...
    <section class="section ec-offer-secti section-space-m">
        ...
        <div class="container">
            <div class="row ec-pos ec-ofr-bnr">
                <!-- <img src="dependencies/images/offer-image/offer_bg.jpg" alt="" class="offer_bg" /> -->
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/29_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/29_4.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                                ...
                                                <div class="ec-pro-actions">
                                                    <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                            src="dependencies/images/icons/pro_wishlist.svg"
                                                            class="svg_img pro_svg" alt="" /></a>
                                                    <a href="#" class="ec-btn-group quickview"
                                                        data-link-action="quickview" title="Quick view"
                                                        data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                                            src="dependencies/images/icons/quickview.svg"
                                                            class="svg_img pro_svg" alt="" /></a>
                                                    <a href="compare.html" class="ec-btn-group compare"
                                                        title="Compare"><img src="dependencies/images/icons/compare.svg"
                                                            class="svg_img pro_svg" alt="" /></a>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/29_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/29_1.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#a88960;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/29_2.jpg"
                                                                        data-src-hover="dependencies/images/product-image/29_2.jpg"
                                                                        data-tooltip="Orange"><span
                                                                            style="background-color:#f778fc;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/29_3.jpg"
                                                                        data-src-hover="dependencies/images/product-image/29_3.jpg"
                                                                        data-tooltip="Green"><span
                                                                            style="background-color:#8b83ff;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/29_4.jpg"
                                                                        data-src-hover="dependencies/images/product-image/29_4.jpg"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/30_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/30_3.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                                ...
                                                <div class="ec-pro-option">
                                                    <div class="ec-pro-opt-inner">
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/30_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/30_1.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#e9e9e9;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/30_2.jpg"
                                                                        data-src-hover="dependencies/images/product-image/30_2.jpg"
                                                                        data-tooltip="Orange"><span
                                                                            style="background-color:#b6f0ff;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/30_3.jpg"
                                                                        data-src-hover="dependencies/images/product-image/30_3.jpg"
                                                                        data-tooltip="Green"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/31_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/31_2.jpg" alt="Product" />
                                                </a>
                                                <div class="ec-pro-actions">
                                                    <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                            src="dependencies/images/icons/pro_wishlist.svg"
                                                ...
                                                <div class="ec-pro-option">
                                                    <div class="ec-pro-opt-inner">
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/31_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/31_1.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#d8bd74;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/31_2.jpg"
                                                                        data-src-hover="dependencies/images/product-image/31_2.jpg"
                                                                        data-tooltip="Orange"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/32_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/32_1.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                                ...
                                                <div class="ec-pro-option">
                                                    <div class="ec-pro-opt-inner">
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/32_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/32_0.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#ac96fd;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/32_2.jpg"
                                                                        data-src-hover="dependencies/images/product-image/32_2.jpg"
                                                                        data-tooltip="Orange"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/33_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/33_3.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                                </span>
                                                ...
                                                <div class="ec-pro-option">
                                                    <div class="ec-pro-opt-inner">
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/33_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/33_1.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#cecece;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/33_2.jpg"
                                                                        data-src-hover="dependencies/images/product-image/33_2.jpg"
                                                                        data-tooltip="Orange"><span
                                                                            style="background-color:#fcb0b0;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/33_3.jpg"
                                                                        data-src-hover="dependencies/images/product-image/33_3.jpg"
                                                                        data-tooltip="Green"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/34_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/34_2.jpg" alt="Product" />
                                                </a>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                                </span>
                                                ...
                                                <div class="ec-pro-option">
                                                    <div class="ec-pro-opt-inner">
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/34_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/34_1.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#e2e2e2;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/34_3.jpg"
                                                                        data-src-hover="dependencies/images/product-image/34_3.jpg"
                                                                        data-tooltip="Orange"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/35_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/35_3.jpg" alt="Product" />
                                                </a>
                                                <div class="ec-pro-actions">
                                                    <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                            src="dependencies/images/icons/pro_wishlist.svg"
                                                ...
                                                <div class="ec-pro-option">
                                                    <div class="ec-pro-opt-inner">
                                                        <div class="ec-pro-color">
                                                            <ul class="ec-opt-swatch ec-change-img">
                                                                <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/35_1.jpg"
                                                                        data-src-hover="dependencies/images/product-image/35_1.jpg"
                                                                        data-tooltip="Gray"><span
                                                                            style="background-color:#fd9191;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/35_2.jpg"
                                                                        data-src-hover="dependencies/images/product-image/35_2.jpg"
                                                                        data-tooltip="Orange"><span
                                                                            style="background-color:#8991ff;"></span></a>
                                                                </li>
                                                                <li><a href="#" class="ec-opt-clr-img"
                                                                        data-src="dependencies/images/product-image/35_3.jpg"
                                                                        data-src-hover="dependencies/images/product-image/35_3.jpg"
                                                                        data-tooltip="Green"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="dependencies/images/product-image/36_1.jpg" alt="Product" />
                                                    <img class="hover-image"
                                                        src="dependencies/images/product-image/36_2.jpg" alt="Product" />
                                                </a>
                                                <div class="ec-pro-actions">
                                                    <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                            src="dependencies/images/icons/pro_wishlist.svg"
                ...
                <div class="ec-banner-inner">
                    <div class="ec-banner-block ec-banner-block-1">
                        <div class="banner-block">
                            <img src="dependencies/images/banner/19.jpg" alt="" />
                    ...
                    <div class="ec-banner-block ec-banner-block-2">
                        <div class="banner-block">
                            <img src="dependencies/images/banner/20.jpg" alt="" />
                            <div class="banner-content">
                                <div class="banner-text">
                    ...
                    <div class="ec-banner-block ec-banner-block-3">
                        <div class="banner-block">
                            <img src="dependencies/images/banner/21.jpg" alt="" />
                            <div class="banner-content">
                                <div class="banner-text">
                                        ...
                                        <div class="ec-spe-pro-cover">
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/8.jpg" alt="">
                                            </div>
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/9.jpg" alt="">
                                            </div>
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/10.jpg" alt="">
                                            </div>
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/11.jpg" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="ec-spe-pro-image-outer col-md-6 col-sm-12">
                                    <div class="ec-spe-pro-image">
                                        <div class="ec-spe-pro-cover">
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/12.jpg" alt="">
                                            </div>
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/13.jpg" alt="">
                                            </div>
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/14.jpg" alt="">
                                            </div>
                                            <div class="ec-spe-pro-slide">
                                                <img class="img-responsive"
                                                    src="dependencies/images/product-image/15.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="ec-spe-pro-thumb">
                                            <div class="ec-spe-pro-slide">
                ...
                <div class="ec-services-section col-lg-3 col-md-3 col-sm-3">
                    ...
                    <div class="ec_ser_block">
                        <div class="ec_ser_content ec_ser_content_1 col-sm-12">
                            <div class="ec_ser_inner">
                                <div class="ec-service-image">
                                    <img src="dependencies/images/icons/service_4_1.svg" class="svg_img ser_svg" alt="" />
                                </div>
                        ...
                        <div class="ec_ser_content ec_ser_content_2 col-sm-12">
                            <div class="ec_ser_inner">
                                <div class="ec-service-image">
                                    <img src="dependencies/images/icons/service_4_2.svg" class="svg_img ser_svg" alt="" />
                                </div>
                                <div class="ec-service-desc">
                        ...
                        <div class="ec_ser_content ec_ser_content_3 col-sm-12">
                            <div class="ec_ser_inner">
                                <div class="ec-service-image">
                                    <img src="dependencies/images/icons/service_4_3.svg" class="svg_img ser_svg" alt="" />
                                </div>
                                <div class="ec-service-desc">
                        ...
                        <div class="ec_ser_content ec_ser_content_4 col-sm-12">
                            <div class="ec_ser_inner">
                                <div class="ec-service-image">
                                    <img src="dependencies/images/icons/service_4_4.svg" class="svg_img ser_svg" alt="" />
                                </div>
                                <div class="ec-service-desc">
                                    <h2>Return Policy</h2>
                        ...
                        <div class="ec_ser_content ec_ser_content_5 col-sm-12">
                            <div class="ec_ser_inner">
                                <div class="ec-service-image">
                                    <img src="dependencies/images/icons/service_4_5.svg" class="svg_img ser_svg" alt="" />
                                </div>
                                <div class="ec-service-desc">
                                    <h2>30% money back</h2>
                                    <p>For Order Over $100</p>
                        ...
                        <ul id="ec-testimonial-slider">
                                ...
                                <div class="ec-test-inner">
                                    <div class="ec-test-img">
                                        <img alt="testimonial" title="testimonial"
                                            src="dependencies/images/testimonial/1.jpg" />
                                    </div>
                                    <div class="ec-test-content">
                                        ...
                                        <div class="ec-test-divider">
                                            <img src="dependencies/images/testimonial/quotes.svg" class="svg_img test_svg"
                                                alt="" />
                                        </div>
                            ...
                            <li class="ec-test-item">
                                <div class="ec-test-inner">
                                    <div class="ec-test-img">
                                        <img alt="testimonial" title="testimonial"
                                            src="dependencies/images/testimonial/2.jpg" />
                                    </div>
                                    <div class="ec-test-content">
                                        <div class="ec-test-name">mark jofferson</div>
                                        <div class="ec-test-designation">- CEO & Founder Invision</div>
                            ...
                            <li class="ec-test-item">
                                <div class="ec-test-inner">
                                    <div class="ec-test-img">
                                        <img alt="testimonial" title="testimonial"
                                            src="dependencies/images/testimonial/3.jpg" />
                                    </div>
                                    <div class="ec-test-content">
                                        <div class="ec-test-name">mark jofferson</div>
                                        <div class="ec-test-designation">- CEO & Founder Invision</div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                <div class="ec-product-inner">
                                    <div class="ec-pro-image-outer">
                                        <div class="ec-pro-image">
                                            <a href="product-left-sidebar.html" class="image">
                                                <img class="main-image" src="dependencies/images/product-image/37_1.jpg"
                                                    alt="Product" />
                                                <img class="hover-image" src="dependencies/images/product-image/37_2.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="flags">
                                                <span class="new">New</span>
                                            ...
                                            <div class="ec-pro-actions">
                                                ...
                                                <a href="#" class="ec-btn-group quickview" data-link-action="quickview"
                                                    ...
                                                    data-bs-target="#ec_quickview_modal"><img
                                                        src="dependencies/images/icons/quickview.svg" class="svg_img pro_svg"
                                                        alt="" /></a>
                                                <a href="compare.html" class="ec-btn-group compare" title="Compare"><img
                                                        src="dependencies/images/icons/compare.svg" class="svg_img pro_svg"
                                                        alt="" /></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                <div class="ec-product-inner">
                                    <div class="ec-pro-image-outer">
                                        <div class="ec-pro-image">
                                            <a href="product-left-sidebar.html" class="image">
                                                <img class="main-image" src="dependencies/images/product-image/35_1.jpg"
                                                    alt="Product" />
                                                <img class="hover-image" src="dependencies/images/product-image/35_3.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="flags">
                                                <span class="sale">Sale</span>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ec-product-content m-auto">
                                <div class="ec-product-inner">
                                    <div class="ec-pro-image-outer">
                                        <div class="ec-pro-image">
                                            <a href="product-left-sidebar.html" class="image">
                                                <img class="main-image" src="dependencies/images/product-image/38_1.jpg"
                                                    alt="Product" />
                                                <img class="hover-image" src="dependencies/images/product-image/38_2.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="flags">
                                                <span class="sale">Sale</span>
                    ...
                    <ul id="ec-brand-slider">
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/1.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/2.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/3.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/4.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/5.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/6.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/7.png" /></a></div>
                        </li>
                        <li class="ec-brand-item">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="dependencies/images/brand-image/8.png" /></a></div>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="insta-auto">
                    ...
                    <div class="ec-insta-item">
                        <div class="ec-insta-inner">
                            <a href="#" target="_blank"><img src="dependencies/images/instragram-image/1.jpg" alt="">
                    ...
                    <div class="ec-insta-item">
                        <div class="ec-insta-inner">
                            <a href="#" target="_blank"><img src="dependencies/images/instragram-image/2.jpg" alt="">
                    ...
                    <div class="ec-insta-item">
                        <div class="ec-insta-inner">
                            <a href="#" target="_blank"><img src="dependencies/images/instragram-image/3.jpg" alt="">
                    ...
                    <div class="ec-insta-item">
                        <div class="ec-insta-inner">
                            <a href="#" target="_blank"><img src="dependencies/images/instragram-image/4.jpg" alt="">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="dependencies/images/product-image/35_1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="dependencies/images/product-image/35_2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="dependencies/images/product-image/35_3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="dependencies/images/product-image/35_2.jpg" alt="">
                                </div>
